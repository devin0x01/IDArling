...
class DedicatedServer(Server):
    ...
    def __init__(self, level, parent=None):
        ...
        log_dir = os.path.join(os.path.dirname(__file__), "logs") # log directory
    ...
    def server_file(self, filename):
        ...
        """
        files_dir = os.path.join(os.path.dirname(__file__), "files") # database.db should be existed in directory files
